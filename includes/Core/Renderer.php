...
class Renderer {
  ...
  public function heading( array $args ): string {
    ...
    <<?php echo $tag; /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- $tag is validated against a fixed allowlist (h2–h6, p) above. */ ?>
    class="onemeta-heading-field__title">
  ...
  public function text( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>
  ...
  public function image( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap onemeta-image-field" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>
      <div class="onemeta-field-title">
        <?php if ( $args['label'] ): ?>
  ...
  public function file( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap onemeta-file-field" data-file-type="<?php echo esc_attr( $args['file_type'] ); ?>" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>
  ...
  public function gallery( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap onemeta-gallery-field" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>
  ...
  public function toggle( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap onemeta-toggle-field" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>
  ...
  public function checkbox( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap onemeta-checkbox-field" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>
      ...
      <div class="onemeta-checkbox-group onemeta-layout-<?php echo esc_attr( $args['layout'] ); ?>">
        <?php if ( ! empty( $args['choices'] ) ): ?>
          ...
          <?php endforeach; ?>
        <?php else: ?>
          <p class="description"><?php esc_html_e( 'No choices defined', 'onemeta' ); ?></p>
        <?php endif; ?>
      </div>
  ...
  public function button_group( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap onemeta-button-group-field" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>
  ...
  public function radio( array $args ): string {
    ...
    ob_start();
    ?>
    <div class="onemeta-field-wrap onemeta-radio-field onemeta-radio-<?php echo esc_attr( $args['layout'] ); ?>" <?php echo $this->get_conditional_attr( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already wraps its value in esc_attr(). ?>>

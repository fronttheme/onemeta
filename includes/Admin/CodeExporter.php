...
class CodeExporter {
	...
	private static function export_value( mixed $value ): string {
		...
		if ( is_string( $value ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_var_export -- Intentional: generates the PHP/array export output users copy into their theme, not leftover debug code.
